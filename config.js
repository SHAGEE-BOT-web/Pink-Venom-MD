...
module.exports = {
    SESSION_ID: process.env.SESSION_ID === undefined ? 'PINKVENOM-MD;DUcSCK7S#CmsaFEH1F3iIdXHY-_Hp5BQy1f_pfAyo5vFBqGqrwKA' : process.env.SESSION_ID, //ADD YOUR SESSION ID
    GITHUB_USER_NAME: process.env.GITHUB_USER_NAME === undefined ? 'SHAGEE-BOT-web' : process.env.GITHUB_USER_NAME, //ADD YOUR GITHUB USERNAME
    GITHUB_AUTH_TOKEN: process.env.GITHUB_AUTH_TOKEN === undefined ? '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' : process.env.GITHUB_AUTH_TOKEN, //ADD YOUR GITHUB AUTH TOKEN WITHOUT gph_ ,  example - G5OxxdvEbiBPWxm4A0xypQGlyCr4FS267ifz
    ...
    OWNER: process.env.OWNER === undefined ? `94710136994` : process.env.OWNER, //BOTS OWNER NUMBER
